...
public static class EngineeringDiagnosticsHtml
{
    ...
    {
        string app = Html(applicationName);
        string account = Html(accountLabel);
        string path = HtmlAttribute(signInPath);
        return $"""
<!doctype html>
<html lang="en">
<head>
...
""";
    ...
    {
        string app = Html(applicationName);
        string system = Html(systemLabel).ToUpperInvariant();
        string api = JavaScriptString(apiBasePath.TrimEnd('/'));
        return $"""
<!doctype html>
<html lang="en">
<head>
...
""";
    ...
    private static string JavaScriptString(string value) => (value ?? string.Empty).Replace("\\", "\\\\").Replace("'", "\\'");
}
