...
public sealed class RegistrationRetryLoop
{
    ...
    public async Task<RegistrationResult> RunUntilRegisteredAsync(ComponentIdentity identity, Action<RegistrationResult>? observeAttempt = null, CancellationToken cancellationToken = default)
    {
        while (true)
        {
